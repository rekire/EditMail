...
public class EditMail extends EditText {
	 ...
	 *            The attributes of the XML tag that is inflating the view.
	 * @param defStyleAttr
	 *            An attribute in the current theme that contains a reference to a style resource to apply to this view. If 0, no default
	 ...
	 * 
	 * @param listener
	 *            The StatusChangedListener to add.
	 ...
	 * 
	 * @param listener
	 * @return <code>true</code> if the listeners were modified by this operation, <code>false</code> otherwise.
	 */
	 ...
	 * @author René Kilczan
	 */
	private final static class Helper extends UiWorker<EditText> implements TextWatcher, OnTouchListener {
		...
		// Sets the error popup on the UI thread, together with a onclick observer to the popup. Well a little hackish made but it works :-)
		@Override
